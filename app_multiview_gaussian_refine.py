...
DEFAULT_OUTPUT_ROOT = os.environ.get("MULTIVIEW_OUTPUT_ROOT", "output/multiview_refine")
DEFAULT_COLMAP_PATH = os.environ.get("COLMAP_PATH", "colmap")
DEFAULT_INFER_CONFIG = os.environ.get("APP_INFER", "./configs/inference/lam-20k-8gpu.yaml")
DEFAULT_MODEL_NAME = os.environ.get("APP_MODEL_NAME", "./model_zoo/lam_models/releases/lam/lam-20k/step_045500/")
...
def launch():
    with gr.Blocks(analytics_enabled=False) as demo:
        ...
        demo.launch(server_name=server_name, server_port=port, max_threads=1)
